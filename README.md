...
Engines expects NN file in current working directory (not nesecceralily the same as petrel application directory itself).
If network data file not found, engine will not start search and reset `option name EvalFile type string default <empty>`
Default name of file (as of version 3.0) is "petrel128.bin".
...
* Perspective [NNUE architecture](https://github.com/jw1912/bullet/blob/main/docs/1-basics.md): 768 -> (2*N) -> 1
