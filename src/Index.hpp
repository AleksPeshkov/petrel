...
template <int _Size, typename _element_type = int, typename _storage_type = int, int _Mask = _Size-1>
class Index {
...
public:
    ...
    constexpr static storage_t Mask = _Mask;
...
template <int _Size, typename _element_type = int, typename _storage_type = int, int _Mask = _Size-1>
class IndexChar : public Index<_Size, _element_type, _storage_type, _Mask> {
    using Base = Index<_Size, _element_type, _storage_type, _Mask>;
    using Base::v;
