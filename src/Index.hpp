...
// Queen, Rook, Bishop
struct Slider : Index<Slider, 3, piece_type_t> { using Index::Index; };

// Queen, Rook, Bishop, Knight
struct Officer : IndexChar<Officer, 4, piece_type_t> { using IndexChar::IndexChar; };
...
// Move { Square to:6; Square from:6; CanBeKiller:1; MoveType:2; } (15 bits)
...
private:
    ...
    // numbers generated by tests/zobrist.cpp script
    enum : _t {
        ZQueen  = U64(0x021e'ad9a'5df9'38a3),
        ZRook   = U64(0x021e'c945'b9d3'57e3),
        ZBishop = U64(0x022a'593c'dfb4'31d7),
        ZKnight = U64(0x0270'cd5b'd8a4'7e5d),
        ZPawn   = U64(0x0314'727e'e966'd5e1),
        ZKing   = U64(0x031f'ab2e'768a'4de1),
