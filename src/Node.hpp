...
class TtSlot {
    ...
    static constexpr u64_t HashMask = U64(0xffffffffffffffff) << TotalShift;
...
public:
    ...
    operator Bound () const { return static_cast<Bound>(v >> BoundShift & BoundMask); }
...
protected:
     ...
     * Killer heuristic
     */
    mutable Move killer1 = {}; // permanent killer, killer2 should trigger twice to become killer1
    mutable Move killer2 = {}; // the most fresh killer, always replaced by sibling's fail high
