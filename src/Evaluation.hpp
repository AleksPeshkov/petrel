...
struct Score {
    ...
    constexpr friend Score operator + (Score s, int e) { s.assertEval(); Score r{static_cast<int>(s) + e}; r.assertEval(); return r; }
    constexpr friend Score operator - (Score s, int e) { s.assertEval(); Score r{static_cast<int>(s) - e}; r.assertEval(); return r; }
...
class DeltaPrunning {
    NonKingType::arrayOf< Score > score = { Score{1200}, Score{600}, Score{400}, Score{400}, Score{150} };
